...
namespace UsedBooks.Models
{
    public class BooksContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<UsedBooks.Models.BooksContext>());

        public BooksContext() : base("name=BooksContext")
        {
        }

        public DbSet<BookUp> BookUp { get; set; }
    }
}
